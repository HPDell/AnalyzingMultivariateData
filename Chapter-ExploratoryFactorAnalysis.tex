            ...
            \begin{subfloatrow}
                \ffigbox{
                    \begin{tikzpicture}[scale=3.5]
                        ...
                        \coordinate (O) at (0,0);
                        \coordinate [label=above:不反胃]         (X1) at ( 0.579,-0.452);
                        \coordinate [label=below:没有副作用]     (X2) at ( 0.522,-0.572);
                        \coordinate [label=below:能止痛]         (X3) at ( 0.645, 0.436);
                ...
                \ffigbox{
                    \begin{tikzpicture}[scale=3.5]
                        ...
                        \coordinate [label=below:能使人保持清醒] (X5) at (-0.034,-0.762);
                        \coordinate [label=below:适度依赖性]     (X6) at (-0.750,-0.074);
                        \draw (O) -- (X1); \cross{X1};
                        \draw (O) -- (X2); \cross{X2};
                        \draw (O) -- (X3); \cross{X3};
                        \draw (O) -- (X4); \cross{X4};
